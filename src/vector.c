...
bool vector_map_func(void* data, void* params) {
	void** pars = (void**)params;
	void* (*map_func)(void*, void*) = (void* (*)(void*, void*))pars[0];
	VECTOR* vector = (VECTOR*)pars[1];
	void* par = pars[2];
...
VECTOR vector_map(VECTOR* vector, size_t target_bytewidth, void* (*map_func)(void*, void*), void* params) {
	VECTOR new_vector = construct_vector(target_bytewidth);
	void* pars[3] = {(void*)map_func, (void*)&new_vector, params};
...
bool vector_min_max_func(void* data, void* params) {
	void** pars = (void**)params;
	bool (*compare_func)(void*, void*, void*) = (bool (*)(void*, void*, void*))pars[0];
...
void* vector_min_max(VECTOR* vector, bool (*compare_func)(void*, void*, void*), void* params) {
	void* min_max = vector->v + vector->head * vector->bytewidth;
	void* pars[3] = {(void*)compare_func, (void*)&min_max, params};
